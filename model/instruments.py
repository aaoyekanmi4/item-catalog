...
category1.tagline = """Electric and acoustic guitars from the major brands.
        Checkout our beginner kits to get you started in no time!"""
...
category2.tagline ="Get 'em in the groove with these great bass guitars."
...
category3.tagline = "A variety of keyboards for whatever sound you need."
...
category4.tagline = """Lay down the beat with these awesome drumsets!
        We've got sets for beginners, experts and everyone in
        between all at affordable prices."""
...
category5.tagline = """Our amps are selected for their incredible sound
        quality and affordability. Suitable for both practice and gigs,
        these amps are sure to make your band sound its best."""
...
category6.tagline = "Play your best with these reliable accesories."
